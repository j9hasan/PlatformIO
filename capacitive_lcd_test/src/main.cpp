/*
 * ESP WiFi Analyzer
 * My display 320*240 resistive touch, settings
 * DF_GFX_SCK 14
 * DF_GFX_MOSI 13
 * DF_GFX_MISO GFX_NOT_DEFINED
 * DF_GFX_CS 15
 * DF_GFX_DC 2
 * DF_GFX_RST GFX_NOT_DEFINED
 * DF_GFX_BL 21
 */
...
// Arduino_GFX *gfx = new Arduino_ILI9488_18bit(bus, DF_GFX_RST, 3 /* rotation */, true /* IPS */);

Arduino_GFX *gfx = new Arduino_ILI9488(
    bus, DF_GFX_RST /* RST */, 0 /* rotation */, true /* IPS */);
